...
//static const char col_cyan[]        = "#1E2541";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_a,      spawn,          SHCMD("acento.sh") },
...
/*	{ MODKEY|ShiftMask,             XK_o,      incrovgaps,     {.i = -1 } }, */
	...
	{ MODKEY,                       XK_y,      spawn,          SHCMD("wallpapers.sh ~/documents/wallpapers &") },
	...
	{ MODKEY,                       XK_Print,  spawn,          SHCMD("scrot -u") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
